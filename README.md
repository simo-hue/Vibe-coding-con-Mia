...
| :--- | :--- | :--- |
| **Home Page** | ![Home Page](docs/screenshots/hero.png) | `hero.png` |
| **Frigo & Dispensa** | ![Frigo](docs/screenshots/fridge_pantry.png) | `fridge_pantry.png` |
| **Dettaglio Ricetta** | ![Ricetta](docs/screenshots/recipe_detail.png) | `recipe_detail.png` |
| **Lista Spesa** | ![Shopping](docs/screenshots/shopping_list.png) | `shopping_list.png` |
