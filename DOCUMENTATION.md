...
- [2026-04-29 09:18]: **Inizio Progetto**
  ...
  - *Tech Notes*: 
    ...
    - Logic: Algoritmo intelligente con "Smart Filtering" e integrazione Spesa/Frigo:
        1.  **Filtro Tempo**: Slider interattivo per filtrare ricette in base ai minuti di preparazione (5-120 min).
        2.  **Persistenza Dati**: Salvataggio automatico di ingredienti, spesa e preferenze di tempo.
        3.  **Match Parziali**: Mostra ricette con >40% di ingredienti comuni.
        4.  **Ingrediente Principale Obbligatorio**: Controllo rigoroso sulla presenza dell'ingrediente core.
        5.  **Automazione Spesa**: Pulsante "Segna da fare" per aggiungere mancanze alla spesa.
        6.  **Check-in Ingredienti**: Pulsante "Tick" nella lista spesa che sposta automaticamente l'ingrediente nel Frigo.
        7.  **Gestione Tab**: Navigazione fluida tra Ricette e Lista Spesa.
